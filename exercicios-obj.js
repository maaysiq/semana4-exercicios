...
//Retorne um objeto no formato: {titulo: "nome do livro", paginas: "número de páginas", 
...
//"O livro XXXX foi escrito por XXX e tem XXX páginas". Você deve utilizar a função que já está pronta, 
//e não reescrever a lógica dela dentro dessa nova função.

function objLivros(titulo, paginas, autoria){
    const livro = { titulo, paginas, autoria}
    return (`O livro ${livro.titulo} foi escrito por ${livro.autoria} e tem ${livro.paginas} paginas`)
}
console.log(objLivros('Antes do Baile Verde', 234, 'Lygia Fagundes Telles'))
...
// Dado um objeto que tem uma propriedade 'nome' e uma propriedade 'sobrenome', a função deve retornar 
//um novo objeto com as mesmas propriedades que o objeto recebido e mais uma propriedade, chamada
//'nomeCompleto', cujo valor é uma string com o nome e sobrenome separados por um espaço.
